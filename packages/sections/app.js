...
var Sections = new Module('sections');

/*
 * All MEAN packages require registration
 * Dependency injection is used to define required modules
 */
Sections.register(function(app, auth, database) {

  //We enable routing. By default the Package Object is passed to the routes
  Sections.routes(app, auth, database);
  ...
  /*
    ...
    */
  Sections.aggregateAsset('css', 'sections.css');
  Sections.aggregateAsset('css', 'jumbotron-narrow.css');
